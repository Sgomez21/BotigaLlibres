...
<head>
    ...
    <link href="{{ asset('css/carrito_style.css') }}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="carrito_producto">
                                <li>
                                    @if ($producto->producto)
                                        <img src="{{ Storage::url($producto->producto->img) }}" width="20%">
                                        {{ $producto->producto->nombre }} - Cantidad: {{ $producto->cantidad }} <a
                                            href="{{ url('/delete_carrito') }}/{{ $producto->id }}"> X </a>
                                    @endif
                                </li>
                            </div>
                        @endforeach
